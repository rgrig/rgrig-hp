...
\entry{2017}
  ...
  \newblock \emph{Effective Interactive Resolution of Static Analysis Alarms}.
  \newblock OOPSLA}
\entry{2017}
  {Xujie Si, Xin Zhang, Radu Grigore, Mayur Naik.
  \newblock \emph{Maximum Satisfiability in Software Analysis:
    Applications and Techniques}.
  \newblock CAV ({\bf invited tutorial})}
\entry{2017}
  {Radu Grigore.
  \newblock \emph{Java Generics Are Turing Complete}.
  \newblock POPL}
\entry{2016}
  {Maria Bruna, Radu Grigore, Stefan Kiefer, Jo\"el Ouaknine, James Worrell.
  \newblock \emph{Proving the Herman-Protocol Conjecture}.
  \newblock ICALP}
\entry{2016}
  {Nikos Tzevelekos, Radu Grigore.
  \newblock \emph{History-Register Automata}.
  \newblock LMCS (supersedes FoSSaCS2013)}
\entry{2016}
  {Radu Grigore,  Hongseok Yang.
  \newblock \emph{Abstraction Refinement Guided by a Learnt Probabilistic Model}.
  \newblock POPL}
\entry{2015}
...
\entry{2016--now}
  {\emph{Introduction to Computer Systems} (Kent): lectures.}
\entry{2016--now}
  {\emph{Systems Architecture} (Kent): lectures.}
\entry{2016--now}
  {\emph{Operating Systems and Architecture} (Kent): lectures.}
\entry{2016}
  {\emph{Theory of Computing} (Kent): classes.}
\entry{2016}
  {\emph{Database Systems} (Kent): classes.}
\entry{2013--2015}
  {\emph{Admission interviews} (Oxford, Worcester College).}
\entry{2014}
  {\emph{Database Systems Implementation}
    (Oxford): I led problem solving sessions.}
\entry{2012}
  {\emph{Computability}
    (QMUL): I marked the exams.}
\entry{2011}
...
\entry{2011}
  {\emph{Algorithms and Data Structures in an Object-Oriented Framework}
    (QMUL): I demonstrated during practicals.}
\entry{2009}
  {\emph{Unix Programming} (UCD): I {\bf designed the course}, and I delivered it.}
\entry{2007--2008}
...
\entry{2008}
  {\emph{Operating Systems} (UCD): I {\bf designed the course}, and I delivered it.}
\entry{2006--2007}
...
\entry{2005--2011}
  ...
  University College Dublin. \gb
  Awarded: 21st June 2011.}
\entry{1998--2003}
  {BSc, \gb
  EE, \gb
